...
template <typename T>
class ofxControlParameter : public ofxControlParameterBase
{
public:
    ofxControlParameter(string name, T *val) : minValue(*val), maxValue(*val)
    {
        this->name = name;
        setOscAddress("/"+name);
        value = val;
    ...
    ofxControlParameter(string name, T min, T max) : value(new T()), minValue(min), maxValue(max)
    {
        this->name = name;
        setOscAddress("/"+name);
    }
...
// reference
template<class T> T* ofxControlParameterBase::getReference() { return dynamic_cast<ofxControlParameter<T>&>(*this).getReference(); }
template<class T> void ofxControlParameterBase::setReference(T *val) { return dynamic_cast<ofxControlParameter<T>&>(*this).setReference(); }

// get
template<class T> T ofxControlParameterBase::get() { return dynamic_cast<ofxControlParameter<T>&>(*this).get(); }
template<class T> void ofxControlParameterBase::set(T val) { return dynamic_cast<ofxControlParameter<T>&>(*this).set(); }

// min
template<class T> T ofxControlParameterBase::getMin() { return dynamic_cast<ofxControlParameter<T>&>(*this).getMin(); }
template<class T> void ofxControlParameterBase::setMin(T min) { return dynamic_cast<ofxControlParameter<T>&>(*this).setMin(); }

// max
template<class T> T ofxControlParameterBase::getMax() { return dynamic_cast<ofxControlParameter<T>&>(*this).getMax(); }
template<class T> void ofxControlParameterBase::setMax(T max) { return dynamic_cast<ofxControlParameter<T>&>(*this).setMax(); }
